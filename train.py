...
data = pd.read_csv("C:/Users/venne/personal_projects/sentimentAnalysis/cleanedSentimentAnalysis.csv", encoding="ISO-8859-1")

print(data.head())


model_directory = "C:/Users/venne/personal_projects/sentimentAnalysis/tweetSentiment/modelDir"
...
with nlp.disable_pipes(*other_pipes):  # only train textcat
    ...
    for epoch in range(10):
        ...
        with nlp.use_params(optimizer.averages):
            nlp.to_disk("c:/Users/venne/personal_projects/sentimentAnalysis/modelDir")
        print("Saved model")
